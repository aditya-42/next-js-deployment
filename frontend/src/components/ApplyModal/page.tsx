...
const ApplyModal: React.FC<ApplyModalProps> = ({ closeModal }) => {

    const router = useRouter();
  const handleApplyManual = () => {
    closeModal(); // Close the modal
    router.push('/applicant/application-form')
    // Redirect to manual application form (you can add a redirect or logic here)
  };

  const handleApplyLinkedIn = () => {
    closeModal(); // Close the modal
    // Redirect or handle LinkedIn authentication here
  };
